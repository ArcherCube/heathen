    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-y-80',
          'data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-y-80',
          position === 'popper' &&
